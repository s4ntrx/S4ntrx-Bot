...
| pip packages (this project) | Flask, SQLAlchemy, Flask-Login, Flask-WTF, python-dotenv, requests (psycopg2-binary only if using Postgres) | ~40–60 MB total in a virtual environment |
